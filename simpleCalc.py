...
button_add = Button(root, text="+", padx=54, pady=20, command=lambda: button_click())
button_equal = Button(root, text="=", padx=117, pady=20, command=lambda: button_click())
button_clear = Button(root, text="Clear", padx=106, pady=20, command=lambda: button_click())
